...
public class AppointmentDTO {
    ...
    public AppointmentDTO(
        ...
        // Auto-calculated fields as per requirement
        this.appointmentDate = appointmentTime.toLocalDate();
        this.appointmentTimeOnly = appointmentTime.toLocalTime();
        this.endTime = appointmentTime.plusHours(1); // Assuming 1-hour appointments
    }

    // Static factory method for convenience (to convert JPA entity to DTO)
