...
public interface PatientRepository extends JpaRepository<Patient, Long>{
    ...
    // 1. Find a patient by their email address (using Spring Data naming convention for simple lookup)
    Optional<Patient> findByEmail(String email);

    // 2. Find a patient using either email OR phone number (using Spring Data naming convention for compound query)
