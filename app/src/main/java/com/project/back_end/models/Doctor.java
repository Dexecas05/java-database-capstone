...
//      - Provides validation for correct input and user experience.
    @NotNull(message = "providing a valid name is required.")
    @Size(min = 3, max = 100)
    private String name;
...
//      - The @Email annotation validates that the email address follows a valid email format (e.g., doctor@example.com).
    @NotNull(message = "an email adress is required.")
    @Email(message = "email adresses must be in a valid format (e.g., doctor@example.com). ")
